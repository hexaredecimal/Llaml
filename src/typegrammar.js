var bnf = {
  ...
  declTypes: [
    ...
    [
      ...
      '$$ = ($3 instanceof yy.TypeFunction) ? new yy.TypeFunction([$1].concat($3.args)) : new yy.TypeFunction([$1, $3]);',
    ],
  ],
...
var grammar = {
  ...
  bnf: {
    ...
    body: [
      [
        'pair',
        '$$ = {types: {}, env: {}}; if($1.data) { $$.types[$1.name] = $1.params; } else { $$.env[$1.name] = $1.type; }',
      ],
      [
        'body TERMINATOR pair',
        '$$ = $1; if($3.data) { $$.types[$3.name] = $3.params; } else { $$.env[$3.name] = $3.type; }',
      ],
      ['body TERMINATOR', '$$ = $1;'],
    ],
    ...
    pair: [
      ...
      [
        'TYPE IDENTIFIER optDataParamList',
        '$$ = {name: $2, params: $3, data: true};',
      ],
    ],

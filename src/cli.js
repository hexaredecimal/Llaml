...
const appConfig = {
  ...
  commands: {
    build: {
      ...
      optional: {
        file: {
          description: 'Run a specific file (optional positional argument)',
        },
      },
    },
    run: {
    ...
    info: {
      description: 'List information about the compiled file',
      subcommands: {
        imports: { description: 'List all imports' },
        types: { description: 'List all types' },
        symbols: { description: 'List all compiled top level symbols' },
      },
      optional: {
        file: { description: 'The source file to load from' },
      },
    },
    version: {

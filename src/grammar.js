...
var n = function (s) {
  return (
    s +
    '$$.lineno = yylineno; $$.filename = yy.filename; $$.column = yy.lexer.tokens[yy.lexer.pos - 2][3];'
  );
};
...
var grammar = {
  ...
  bnf: {
    ...
    openModule: [
      [
        'OPEN importPATH liftOrNot',
        n(
          '$$ = $3 == null ? new yy.importIntoModule($2) : new yy.importIntoModule($2, $3);',
        ),
      ],
    ],
    liftOrNot: [
    ...
    annotationArg: [
      [
        'IDENTIFIER annotationArg2',
        '$$ = $2.length == 0 ? new yy.IdAnnotation($1) : new yy.FuncAnnotation($1, $2);',
      ],
    ],
    annotationArg2: [
      ['', '$$ = [];'],
    ...
    letInBindings: [
      [
        'IDENTIFIER optType = innerExpression',
        '$$ = [{name: $1, value: $4, type: $2}];',
      ],
      [
        'letInBindings IDENTIFIER optType = innerExpression',
        '$$ = $1; $1.push({name: $2, value: $5, type: $3});',
      ],
    ],
    callArgument: [
      ['( expression )', n('$$ = $2;')],
      ...
      [
        ...
        n('$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);'),
      ],
      [
        'innerExpression MATH innerExpression',
        n('$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);'),
      ],
      [
        'innerExpression CONCAT innerExpression',
        n('$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);'),
      ],
      [
        'innerExpression + innerExpression',
      ...
      [
        'innerExpression BOOLOP innerExpression',
        n('$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);'),
      ],
      [
        'innerExpression COMPARE innerExpression',
        n('$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);'),
      ],
      [
        'innerExpression OPERATOR innerExpression',
        n('$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);'),
      ],
      [
        'innerExpression : innerExpression',
      ...
      [
        'LAMBDA paramList optType RIGHTARROW expression',
        n('$$ = new yy.Function(undefined, $2, [$5], $3);'),
      ],
      ['literal', '$$ = $1;'],
    ],
    unaryExpression: [
    ...
    caseList: [
      ...
      [
        'caseList | pattern = expression',
        '$$ = $1; $1.push(new yy.Case($3, $5));',
      ],
    ],
    pattern: [
    ...
    patternArray: [['[ optPatternValues ]', n('$$ = new yy.Array($2);')]],
    ...
    patternObject: [['{ optPatternPairs }', n('$$ = new yy.Object($2);')]],
    ...
    listConstPattern: [
      [
        'pattern : listConstPatternItems',
        n('$$ = new yy.ListConstPattern([$1, ...$3]);'),
      ],
    ],
    ...
    ifThenElse: [
      [
        'IF innerExpression THEN innerExpression ELSE innerExpression',
        n('$$ = new yy.IfThenElse($2, [$4], [$6]);'),
      ],
    ],
    ...
    typeDecl: [
      [
        'TYPE IDENTIFIER optDataParamList = dataOrAlias',
        n(
    ...
    dataList: [
      ...
      [
        'dataList | IDENTIFIER optTypeParamList',
        '$$ = $1; $1.push(new yy.Tag($3, $4));',
      ],
    ],
    ...
    function: [
      [
        'funcName paramList optType rhsValue optWhere',
        n('$$ = new yy.Function($1, $2, $4, $3, $5);'),
      ],
      [
        'funcName = FUNCTION caseList optWhere',
        n(
          "$$ = new yy.Function($1, [new yy.Arg('__arg')], [new yy.Match(new yy.Identifier('__arg'), $4)], undefined, $5);",
        ),
      ],
    ],
    binding: [
    ...
    whereDecl: [
      ['dataDecl', '$$ = $1;'],
      [
        'funcName paramList optType = expression optWhere',
        n('$$ = new yy.Function($1, $2, [$5], $3, $6);'),
      ],
    ],
    ...
    object: [['{ optPairs }', n('$$ = new yy.Object($2);')]],
    optValues: [
      ['', '$$ = [];'],
      ['arrayValues', '$$ = $1;'],
    ],
    ...
    keyPairs: [
      ...
      [
        'keyPairs , keywordOrIdentifier',
        '$$ = $1; $1[$3] = new yy.Identifier($3);',
      ],
    ],
    accessor: [
      ['IDENTIFIER', n('$$ = new yy.Identifier($1);')],
      [
        'accessor . keywordOrIdentifier',
        n('$$ = new yy.PropertyAccess($1, $3);'),
      ],
      [
        '( expression ) . keywordOrIdentifier',
        n('$$ = new yy.PropertyAccess($2, $5);'),
      ],
    ],
    keywordOrIdentifier: typegrammar.keywordOrIdentifier,
    identifier: [['IDENTIFIER', n('$$ = new yy.Identifier($1);')]],
  },
};
